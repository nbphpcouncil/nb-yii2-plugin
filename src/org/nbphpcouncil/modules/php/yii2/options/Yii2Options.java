 ...
 */
package org.nbphpcouncil.modules.php.yii2.options;
 ...
 * @author junichi11
 */
public class Yii2Options {

    private static final String PREFERENCES_PATH = "yii2"; // NOI18N
    private static final String COMPOSER_PREFERENCES_PATH = "composer"; // NOI18N
    private static final Yii2Options INSTANCE = new Yii2Options();

    private Yii2Options() {
    }

    public static Yii2Options getInstance() {
        return INSTANCE;
    }
    ...
    private Preferences getPreferences() {
        return NbPreferences.forModule(Yii2Options.class).node(PREFERENCES_PATH);
    }
