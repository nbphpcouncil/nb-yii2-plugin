...
public class Yii2DefaultModule extends Yii2Module {

    public Yii2DefaultModule(PhpModule phpModule, PathAliases pathAliases) {
    ...
    @Override
    public FileObject getDirectory(Alias aliases) {
        return null;
    }
